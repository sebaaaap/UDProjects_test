...
export function ProyectoDetalle({ proyecto, volver }) {
    ...
    useEffect(() => {
        const cargarArchivos = async () => {
            try {
                ...
                const response = await fetch(`${import.meta.env.VITE_API_URL ? import.meta.env.VITE_API_URL : '/api'}/proyectos/${proyecto.id}/archivos`, {
                    credentials: 'include'
                });
    ...
    if (proyecto.estado === "propuesto") {
        ...
        if (usuario && usuario.id === proyecto.creador_id) {
            ...
            fetch(`${import.meta.env.VITE_API_URL ? import.meta.env.VITE_API_URL : '/api'}/proyectos/${proyecto.id}/postulaciones`, { credentials: 'include' })
        ...
        fetch(`${import.meta.env.VITE_API_URL ? import.meta.env.VITE_API_URL : '/api'}/proyectos/${proyecto.id}/integrantes`, { credentials: 'include' })
    ...
    const handleDescargarArchivo = async (archivoId) => {
        try {
            const response = await fetch(
                `${import.meta.env.VITE_API_URL ? import.meta.env.VITE_API_URL : '/api'}/proyectos/${proyecto.id}/archivos/${archivoId}/descargar`,
                {
                    credentials: 'include'
                }
            );
    ...
    const handleEliminarArchivo = async (archivoId) => {
        ...
        try {
            const response = await fetch(
                `${import.meta.env.VITE_API_URL ? import.meta.env.VITE_API_URL : '/api'}/proyectos/${proyecto.id}/archivos/${archivoId}`,
                {
                    method: 'DELETE',
                    credentials: 'include'
                }
    ...
    const cambiarEstadoPostulacion = async (postulacionId, nuevoEstado) => {
        try {
            const response = await fetch(`${import.meta.env.VITE_API_URL ? import.meta.env.VITE_API_URL : '/api'}/proyectos/postulaciones/${postulacionId}/estado-creador`, {
                method: "PATCH",
                credentials: "include",
